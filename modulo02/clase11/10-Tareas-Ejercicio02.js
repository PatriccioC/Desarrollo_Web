...
// Ejercicio 2
// 2️⃣ Mostrar solo impares
console.log("Mostrar los impares del 1 al 100")
for (let i = 1; i <= 100; i++) {
    if (i%2 === 1) {
        console.log(i); 
    }
...
// Ejercicio 2.1
// Lo mismo pero muesta los núneros impares agrupados de 5
// para poder observar los 100

let fila_de_a_5 = ""; // Definimos una variable vacía
...
for (let i = 1; i <= 100; i++) {
    ...
    // i%2 === 1 lo usamos para separar solo los impares

    if (i%2 === 1) {
        fila_de_a_5 += i.toString().padStart(10, " ") + " "; 
    }


    // Si el número es múltiplo de 10, imprimimos la fila y la vaciamos
    if (i % 10 === 0) {
        console.log(fila_de_a_5);
        fila_de_a_5 = ""; // Dejamos la variable vacía para iniciar la proxima fila
    }
}
